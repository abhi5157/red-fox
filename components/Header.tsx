          ...
          <Link href="/" className="flex items-center space-x-3">
            <div className="w-14 h-12 flex items-center justify-center">
              ...
              <Image
                ...
                width={150}
                height={100}
                className={`transition-all duration-300 ${scrolled ? 'brightness-100' : 'brightness-200'}`}
              // className={`transition-all duration-300 rounded ${scrolled ? 'bg-white p-1 shadow-sm' : ''}`}
            ...
            <div className="text-2xl font-bold" style={{ fontFamily: 'var(--font-inter)' }}>
              <span className={scrolled ? 'text-red-600' : 'text-white'}>RED</span>
              <span className={scrolled ? 'text-gray-600' : 'text-red-200'}>FOX</span>
            </div>

          </Link>

          <nav className="hidden md:flex space-x-8">
            <Link href="/" className={`font-medium transition-colors duration-200 hover:text-red-600 ${scrolled ? 'text-gray-900' : 'text-white hover:text-red-400'
              }`}>
              Home
            </Link>
            <Link href="/about" className={`font-medium transition-colors duration-200 hover:text-red-600 ${scrolled ? 'text-gray-900' : 'text-white hover:text-red-400'
              }`}>
              About
            </Link>
            ...
            <Link href="/contact" className={`font-medium transition-colors duration-200 hover:text-red-600 ${scrolled ? 'text-gray-900' : 'text-white hover:text-red-400'
              }`}>
              Contact
            </Link>
          </nav>
